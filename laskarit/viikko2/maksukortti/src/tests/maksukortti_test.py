...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_negatiivisen_summan_lataaminen_ei_vie_saldoa(self):
        self.kortti.lataa_rahaa(-500)
        
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 10.00 euroa")
    
    def test_syo_edullisesti_kun_kortilla_saman_verran_rahaa(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()
        
        self.assertEqual(str(kortti), "Kortilla on rahaa 0.00 euroa")
    
    def test_syo_maukkaasti_kun_kortilla_saman_verran_rahaa(self):
